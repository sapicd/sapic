...
class UtilsTest(unittest.TestCase):
    ...
    def test_utils(self):
        ...
        self.assertEqual("a9993e364706816aba3e25717850c26c9cd0d89d", sha1("abc"))
        ...
        self.assertEqual(format_upload_src("1.1", baseimg), {"1": {"1": baseimg}})
        ...
        self.assertEqual(parse_author_mail("staugur <mail>"), ("staugur", "mail"))
