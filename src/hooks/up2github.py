...
__description__ = '将图片保存到github.com'
__state__ = 'disabled'
__catalog__ = 'upload'
...
<fieldset class="layui-elem-field">
    <legend>GitHub存储（{% if "up2github" in g.site.upload_includes %}使用中{% else %}未使用{% endif %}）</legend>
    <div class="layui-field-box">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="github_repo" value="{{ g.site.github_repo }}" placeholder="格式：用户名/仓库名"
                    autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
